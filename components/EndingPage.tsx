      ...
      >
        {isSummaryLoading ? (
          <div className="flex flex-col items-center justify-center p-4 text-slate-700 text-lg">
            ...
            <p className="mt-4 text-slate-600 font-semibold">Generating your final summary...</p>
            <p className="text-sm text-slate-500 mt-2">If there's a backup, your results are waiting in line.</p>
          </div>
        ) : summaryError ? (
